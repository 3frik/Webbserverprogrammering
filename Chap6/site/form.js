...
//Programmet kommer att använda information som är sparat i servern i filen credentials.js
var credentials= require('./credentials.js');
//Med den här installerar vi cookie-parser
app.use(require('cookie-parser')(credentials.secretKey));
console.log(credentials.secretKey);
...
app.post('/process', function (req,res){
    ...
    // såhär sparar vi ett värde i ett cookie.
    // värdet sparas i användarens dator, inte i servern.
    res.cookie('cookieValue', req.body.color);
